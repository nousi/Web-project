<?php
    ...
    if(isset($_POST['save'])){
        ...
        $query="UPDATE users SET FirstName='$fname',LastName='$lname', city='$city' ,age='$age' ,gender='$gender' ,bio='$bio',phone='$phone' WHERE email='$user_email' ";
        $query_run=mysqli_query($con,$query);
    
        if($query_run){
            //$_SESSION['message']="updated";
            echo $bio;
            header('Location: PprofileView.php');
