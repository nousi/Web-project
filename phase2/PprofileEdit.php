...
<body>
     ...
     <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                <a href="ReqviewP.html" class="nav-item nav-link"> my requests with their status</a>
                <a href="list req.html" class="nav-item nav-link"> list of requests</a>                
                <div class="nav-item dropdown">
                <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">SESSIONS</a>
                <div class="dropdown-menu fade-down m-0">
                    <a href="ViewSessions.html" class="dropdown-item">Current session</a>
                    <a href="ViewSessions_PRE.html" class="dropdown-item">Previous session</a>
                   
                </div>
            </div>                    
                
                <a href="ViewReviews.html" class="nav-item nav-link">Review & Rate </a>
                <div class="nav-item dropdown">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu fade-down m-0">
                        <a href="PprofileView.php" class="dropdown-item">view your profile</a> 
                        <a href="PprofileEdit.php" class="dropdown-item">Edit your profile</a>
    ...
    <div class="container light-style flex-grow-1 container-p-y">
        <h4 class="font-weight-bold py-3 mb-4">
            Profile managing (Language partner)
        </h4>
        <?php
        if(isset($_GET['email'])){
                    ...
                    <div class="col-md-9">
                        <div class="tab-content">
                            <div class="tab-pane fade active show" id="account-general">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="fname" value="<?= $user['FirstName']; ?>  " class="form-control mb-1"  required>
                                    </div>
                                    <div class="form-group">
                            ...
                            <div class="tab-pane fade" id="account-change-password">
                                ...
                                <div class="form-group">
                                <input type="hidden" name="email" value="<?= $user['email']; ?>" class="form-control mb-1" >
                                </div>
                                    <div class="form-group">
                            ...
                            <div class="tab-pane fade" id="account-info">
                                <div class="card-body pb-2">
                                    <div class="form-group">
                                        ...
                                        <textarea  name="txtarea" value="<?= $user['bio']; ?>" placeholder="(e.g. Naitve English speaker , write cultural knowledge)" class="form-control"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="phone" class="form-control" value="<?= $user['phone']; ?>"  placeholder="+966 534 567 891">
                                </div>
                                </div>
                            </div>
