...
<body>
   ...
   <!-- Navbar End -->
    ...
    ?>
    <h2 style="color: #2c6783;">Current Language Sessions</h2>
        ...
        <?php
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                <div class="session-card">
                    <h5>Start Date: <?php echo $row['startDateTime']; ?></h5>
                    <h5>End Date: <?php echo $row['endDateTime']; ?></h5>
                    <p>Topics Covered: <?php echo $row['subject']; ?></p>
                    <h6>Learner: <a href="mailto:<?php echo $row['Lemail']; ?>">Send Email</a></a></h5>
                     <?php 
                       ?>
