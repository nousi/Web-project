...
if(isset($_SESSION['partnerEmail'])) {
    ...
    $partner_email= $_SESSION['partnerEmail'];

    // Query to fetch requests related to the partner's email
    $query = "SELECT * FROM requests WHERE partnerEmail = '$partner_email'";
    ...
    if(mysqli_num_rows($result) > 0) {
        ...
        echo "<tr><td colspan='8'>No requests found for the partner.</td></tr>";
    }
} else {
