...
<body>
   ...
   <!-- Navbar End -->
            ...
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu fade-down m-0">
                        <a href="Current_session.php" class="dropdown-item">Current session</a>
                        <a href="Previous_session.php" class="dropdown-item">Previous session</a>
    ...
    <!-- Navbar End  -->
    <br>
    <h2 style="color: #2c6783;">Previous Language Sessions</h2>
    <div class="session-grid">
        <div class="session-card">
            <h3>Session Date: January 25, 2024</h3>
            <p>Language: Spanish</p>
            <p>Topics Covered: Conversation practice, grammar review</p>
            <a  href="Rate.html">
                <button class="btn btn-outline-primary" >Rate & Review</button></a>
        </div>
        <div class="session-card">
            <h3>Session Date: February 10, 2024</h3>
            <p>Language: French</p>
            <p>Topics Covered: Vocabulary building, cultural insights</p>
            <a  href="Rate.html">
                <button class="btn btn-outline-primary" >Rate & Review</button></a>
        </div>
