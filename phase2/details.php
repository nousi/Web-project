...
<?php
    ...
    // Retrieve partner details based on fname and lname from URL parameters
    $fname = $_GET['fname'];
    $lname = $_GET['lname'];

    // SQL query to retrieve details of the specific partner
    $sql = "SELECT fname, lname, bio, Proficiency, SessionPrice FROM partner WHERE fname = '$fname' AND lname = '$lname'";
    $result = $conn->query($sql);

    // Display partner profile based on query results
    if ($result->num_rows > 0) {
        $row = $result->fetch_assoc();
        echo '<div class="partner-profile">';
        echo '<img src="user_icon.png" alt="Partner Image" class="profile-image">';
        echo '<div class="profile-info">';
        echo '<h2>' . $row["fname"] . ' ' . $row["lname"] . '</h2>';
        echo '<p>Bio: ' . $row["bio"] . '</p>';
        echo '<p>Proficiency:</p>';
        // Assuming Proficiency details are stored in a structured format (e.g., comma-separated values)
        $proficiencyList = explode(',', $row["Proficiency"]);
        foreach ($proficiencyList as $item) {
            echo '<span>' . $item . '</span><br>';
        }
        echo '<div class="price">';
        echo '<p>Session Price per Hour: $' . $row["SessionPrice"] . '</p>';
        echo '</div>';
        echo '<center>';
        echo '<a href="chat.html" style="color: #fff;"><button>Send Message</button></a>';
        echo '<a href="save_request.php" style="color: #fff;"><button>Make a Request</button></a>';
        echo '</center>';
        echo '</div>';
        echo '</div>';
    } else {
    ...
    ?>
            <div class="review-section">
                ...
                <div class="user-review">
                    <div class="user-info">
                        <img src="img/testimonial-1.jpg" alt="Student 2" class="user-avatar">
                        <div class="user-name">Norah hadi</div>
                    </div>
                ...
                <div class="user-review">
                    <div class="user-info">
                        <img src="img/testimonial-3.jpg" alt="Student 1" class="user-avatar">
                        <div class="user-name">Hassan ahmed</div>
                    </div>
                    <div style="color: #ffc107;">
                        <span class="star">&#9733;</span>
                        <span class="star">&#9733;</span>
                ...
                <div class="user-review">
                    <div class="user-info">
                        <img src="img/testimonial-2.jpg" alt="Student 4" class="user-avatar">
                        <div class="user-name">Sami Al-Fhad</div>
                    </div>
                    <div style="color: #ffc107;">
                        <span class="star">&#9733;</span>
                        <span class="star">&#9733;</span>
